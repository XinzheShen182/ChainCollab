...
def run_experiment(
    ...
    param={
        "Participant_0ggs0ck": {
            ...
            "multiMaximum": 0,
            "multiMinimum": 0,
            "x509": "eDUwOTo6Q049dXNlcjEsT1U9Y2xpZW50OjpDTj1jYS5vcmcxLm9yZy5jb20sT1U9RmFicmljLE89b3JnMS5vcmcuY29tLFNUPU5vcnRoIENhcm9saW5hLEM9VVM=@Org1.org.comMSP"
        },
        "Participant_1v6wnpq": {
            "msp": "Org1.org.comMSP",
            "attributes": {},
            ...
            "multiMaximum": 0,
            "multiMinimum": 0,
            "x509": "eDUwOTo6Q049dXNlcjIsT1U9Y2xpZW50OjpDTj1jYS5vcmcxLm9yZy5jb20sT1U9RmFicmljLE89b3JnMS5vcmcuY29tLFNUPU5vcnRoIENhcm9saW5hLEM9VVM=@Org1.org.comMSP"
        },
        "Participant_0tkhpj2": {
            "msp": "Org1.org.comMSP",
            "attributes": {},
            ...
            "multiMaximum": 0,
            "multiMinimum": 0,
            "x509": "eDUwOTo6Q049dXNlcjMsT1U9Y2xpZW50OjpDTj1jYS5vcmcxLm9yZy5jb20sT1U9RmFicmljLE89b3JnMS5vcmcuY29tLFNUPU5vcnRoIENhcm9saW5hLEM9VVM=@Org1.org.comMSP"
        },
    ...
    url="http://127.0.0.1:5001/api/v1/namespaces/default/apis/Blood-ae7aa3"
    contract_name="Blood"
    

    create_instance_params = {"input": {"initParametersBytes": json.dumps(param)}}
    contract_interface_id = "669ed36f-a714-4f67-b8c9-bf88da448314"

    participant_map = {
        "Participant_0ggs0ck": {
            "key": "Org1.org.comMSP::x509::CN=user1,OU=client::CN=ca.org1.org.com,OU=Fabric,O=org1.org.com,ST=North Carolina,C=US",
            "fireflyUrl": "http://localhost:5001/api/v1/namespaces/default/apis/Blood-ae7aa3",
        },
        "Participant_1v6wnpq": {
            "key": "Org1.org.comMSP::x509::CN=user2,OU=client::CN=ca.org1.org.com,OU=Fabric,O=org1.org.com,ST=North Carolina,C=US",
            "fireflyUrl": "http://localhost:5001/api/v1/namespaces/default/apis/Blood-ae7aa3",
        },
        "Participant_0tkhpj2": {
            "key": "Org1.org.comMSP::x509::CN=user3,OU=client::CN=ca.org1.org.com,OU=Fabric,O=org1.org.com,ST=North Carolina,C=US",
            "fireflyUrl": "http://localhost:5001/api/v1/namespaces/default/apis/Blood-ae7aa3",
        }
    }
