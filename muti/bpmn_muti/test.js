...
export const machine = createMachine(
    ...
    states: {
                    ...
                    always: [
                      {
                        ...
                        cond: "Participant_19j1e3o_isNotLocked",
                        actions: [
                          {
                      ...
                      },
                      {
                        ...
                        cond: "Participant_19j1e3o_isLocked",
                        actions: [],
                      },
                    ],
                  },
                        ...
                        states: {
                          disable: {
                            always: [
                              {
                                target: "enable",
                                cond: "active_Participant_19j1e3o_machine_1",
                                actions: [],
                              },
                              {
                                target: "locked_done",
                                cond: "inactive_Participant_19j1e3o_machine_1",
                                actions: [],
                              },
                            ],
                          },
                        ...
                        states: {
                          disable: {
                            always: [
                              {
                                target: "enable",
                                cond: "active_Participant_19j1e3o_machine_2",
                                actions: [],
                              },
                              {
                                target: "locked_done",
                                cond: "inactive_Participant_19j1e3o_machine_2",
                                actions: [],
                              },
                            ],
                          },
      ...
      Message_0i5t589: {
        ...
        onDone: [
          {
            target: "Message_0i5t589",
            cond: "Message_0i5t589_NotLoopMax",
            actions: [
              {
          ...
          },
          {
            ...
            cond: "Message_0i5t589_LoopConditionMeet",
            actions: [],
          },
          {
            target: "Message_0oi7nug",
            cond: "Message_0i5t589_LoopMax",
            actions: [],
          },
        ],
      },
        ...
        always: [
          {
            ...
            cond: "Gateway_0ep8cuh__Message_1oxmq1k",
            actions: [],
          },
          {
            target: "Message_0d2xte5",
            cond: "Gateway_0ep8cuh__Message_0d2xte5",
            actions: [],
          },
        ],
      },
      ...
      Message_0d2xte5: {
        ...
        onDone: [
          {
            target: "Message_0d2xte5",
            cond: "Message_0d2xte5_NotLoopMax",
            actions: [
              {
      ...
      Gateway_1cr0nma: {
        always: {
          ...
          cond: "Gateway_1cr0nma__Event_13pbqdz",
          actions: [],
        },
      },
      Event_13pbqdz: {
  ...
  },
  {
    ...
    services: {},
    guards: {
      Participant_19j1e3o_isNotLocked: (context, event) => {
        return false;
      },
      Participant_19j1e3o_isLocked: (context, event) => {
        return false;
      },
      active_Participant_19j1e3o_machine_1: (context, event) => {
        return false;
      },
      inactive_Participant_19j1e3o_machine_1: (context, event) => {
        return false;
      },
      active_Participant_19j1e3o_machine_2: (context, event) => {
        return false;
      },
      inactive_Participant_19j1e3o_machine_2: (context, event) => {
        return false;
      },
      Message_0i5t589_NotLoopMax: (context, event) => {
        return false;
      },
      Message_0i5t589_LoopConditionMeet: (context, event) => {
        return false;
      },
      Message_0i5t589_LoopMax: (context, event) => {
        return false;
      },
      Gateway_0ep8cuh__Message_1oxmq1k: (context, event) => {
        return false;
      },
      Gateway_0ep8cuh__Message_0d2xte5: (context, event) => {
        return false;
      },
      Gateway_1cr0nma__Event_13pbqdz: (context, event) => {
        return false;
      },
      Message_0d2xte5_NotLoopMax: (context, event) => {
        return false;
      },
      Message_0d2xte5_LoopMax: (context, event) => {
        return false;
      },
    },
    delays: {},
