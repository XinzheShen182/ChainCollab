...
export default function MagicPropertiesProvider(injector, bpmnFactory) {
  ...
  MagicPropertiesProvider.prototype.conditionalEvent = function(group, element) {
...
inherits(MagicPropertiesProvider, BpmnPropertiesProvider);
